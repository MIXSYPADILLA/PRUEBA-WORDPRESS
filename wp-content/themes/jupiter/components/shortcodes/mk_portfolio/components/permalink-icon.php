...
<a class="hover-icon from-left project-load" target="<?php echo $view_params['target']; ?>" href="<?php echo $href; ?>" data-post-id="<?php the_ID(); ?>"><?php Mk_SVG_Icons::get_svg_icon_by_class_name(true, $view_params['permalink_icon_name'], 32); ?></a>