<?php
/**
 * This file is responsible for icon library general functions.
 *
...
class Mk_Icon_Library {
	...
	function get_library_view() {
		...
		echo '<div class="wrap icon-library-page">';
			...
			echo '<p>' . __( 'Search and find your desired icon and paste its "class name" into the "text field" provided in shortcode options.', 'mk_framework' ) . '</p>';
