<?php
/**
 * Spark Construction Theme Customizer Control Classes
 *
...
if( class_exists( 'WP_Customize_Control' ) ) { 
    ...
    /**
     * Class sparkconstructionlite_Repeater_Control
     */
    class sparkconstructionlite_Repeater_Control extends WP_Customize_Control {
        ...
        public function __construct( $manager, $id, $args = array() )
        {
            ...
            if ( ! isset( $args['allow_unlimited'] ) || $args['allow_unlimited'] != false ) {
                $this->max_item =  apply_filters( 'spark_construction_reepeatable_max_item', absint( $args['max_item'] ) );
            }  else {
                $this->max_item = absint( $args['max_item'] );
            }

            $this->changeable =  isset(  $args['changeable'] ) && $args['changeable'] == 'no' ? 'no' : 'yes';
            $this->default_empty_title =  isset(  $args['default_empty_title'] ) && $args['default_empty_title'] != '' ? $args['default_empty_title'] : esc_html__( 'Item', 'spark-construction-lite' );
        ...
        public function render_content() {
            ...
            <div class="repeatable-actions">
                <span class="button-secondary add-new-repeat-item"><?php echo !empty( $this->add_text ) ? esc_html( $this->add_text ) : esc_html__( 'Add an item', 'spark-construction-lite' ); ?></span>
            </div>
            <?php
        }
                ...
                <div class="widget">
                    <div class="widget-top">
                        ...
                        <div class="widget-title">
                            <h4 class="live-title"><?php esc_html_e( 'Item', 'spark-construction-lite' ); ?></h4>
                        </div>
                    </div>
                                    ...
                                    <# if ( field.type ){ #>
                                        ...
                                        #>
                                            ...
                                            <# } else if ( field.type === 'number' ) { #>
                                                <input data-live-id="{{ field.id }}" type="number" value="{{ field.value }}" data-repeat-name="_items[__i__][{{ field.id }}]" class="">
                                            ...
                                            <# } else if ( field.type == 'media' ) { #>
                                                ...
                                                <div class="actions">
                                                    <button class="button remove-button " <# if ( ! field.value.url ){ #> style="display:none"; <# } #> type="button"><?php esc_html_e( 'Remove', 'spark-construction-lite' ) ?></button>
                                                    <button class="button upload-button" data-media="{{field.media}}" data-add-txt="<?php esc_attr_e( 'Add', 'spark-construction-lite' ); ?>" data-change-txt="<?php esc_attr_e( 'Change', 'spark-construction-lite' ); ?>" type="button"><# if ( ! field.value.url  ){ #> <?php esc_html_e( 'Add', 'spark-construction-lite' ); ?> <# } else { #> <?php esc_html_e( 'Change', 'spark-construction-lite' ); ?> <# } #> </button>
                                            ...
                                            <# }  else if ( field.type == 'icon'  ) { #>
                                                ...
                                                <a href="#" class="remove-icon"><?php esc_html_e( 'Remove', 'spark-construction-lite' ); ?></a>
                                            <# }  #>
                                ...
                                <div class="widget-control-actions">
                                    <div class="alignleft">
                                        <span class="remove-btn-wrapper">
                                            <a href="#" class="repeat-control-remove" title=""><?php esc_html_e( 'Remove', 'spark-construction-lite' ); ?></a> |
                                        </span>
                                        <a href="#" class="repeat-control-close"><?php esc_html_e( 'Close', 'spark-construction-lite' ); ?></a>
                                    </div>
                                    <br class="clear">
                                </div>
