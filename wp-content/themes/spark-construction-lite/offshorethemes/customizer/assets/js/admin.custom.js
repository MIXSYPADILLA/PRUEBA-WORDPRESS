        ...
        _init: function() {
            ...
            control.actions = function ($context) {
                if (control.params.live_title_id) {
                    ...
                    if (control.id === 'spark_construction_section_order_styling') {
    ...
    function _the_editor( container ){
        var _editor = {
            ...
            ready: function( container ) {
                ...
                control.container.addClass( 'sparkconstructionlite-editor-added' );
...
jQuery( window ).ready( function( $ ){
    ...
    if ( typeof spark_construction_customizer_settings !== "undefined" ) {
        if (spark_construction_customizer_settings.number_action > 0) {
            $('.control-section-themes h3.accordion-section-title').append('<a class="theme-action-count" href="' + spark_construction_customizer_settings.action_url + '">' + spark_construction_customizer_settings.number_action + '</a>');
        }
    }
     ...
     */
    $( 'select[data-customize-setting-link="spark_construction_hero_layout"]').on( 'change on_custom_load', function(){
        var v = $( this).val() || '';

        $( "li[id^='customize-control-spark_construction_hcl']").hide();
        $( "li[id^='customize-control-spark_construction_hcl"+v+"']").show();

    } );
    $( 'select[data-customize-setting-link="spark_construction_hero_layout"]').trigger( 'on_custom_load' );


    /**
     * For Gallery content settings
     */
    $( 'select[data-customize-setting-link="spark_construction_gallery_source"]').on( 'change on_custom_load', function(){
        var v = $( this).val() || '';

        $( "li[id^='customize-control-spark_construction_gallery_source_']").hide();
        $( "li[id^='customize-control-spark_construction_gallery_api_']").hide();
        $( "li[id^='customize-control-spark_construction_gallery_settings_']").hide();
        $( "li[id^='customize-control-spark_construction_gallery_source_"+v+"']").show();
        $( "li[id^='customize-control-spark_construction_gallery_api_"+v+"']").show();
        $( "li[id^='customize-control-spark_construction_gallery_settings_"+v+"']").show();

    } );

    $( 'select[data-customize-setting-link="spark_construction_gallery_source"]').trigger( 'on_custom_load' );

    /**
     * For Gallery display settings
     */
    $( 'select[data-customize-setting-link="spark_construction_gallery_display"]').on( 'change on_custom_load', function(){
        var v = $( this).val() || '';
        switch ( v ) {
            case 'slider':
                $( "#customize-control-spark_construction_g_row_height, #customize-control-spark_construction_g_col, #customize-control-spark_construction_g_spacing").hide();
                break;
            case 'justified':
                $( "#customize-control-spark_construction_g_col, #customize-control-spark_construction_g_spacing").hide();
                $( "#customize-control-spark_construction_g_row_height").show();
                break;
            case 'carousel':
                $( "#customize-control-spark_construction_g_row_height, #customize-control-spark_construction_g_col").hide();
                $( "#customize-control-spark_construction_g_col, #customize-control-spark_construction_g_spacing").show();
                break;
            case 'masonry':
                $( "#customize-control-spark_construction_g_row_height").hide();
                $( "#customize-control-spark_construction_g_col, #customize-control-spark_construction_g_spacing").show();
                break;
            default:
                $( "#customize-control-spark_construction_g_row_height").hide();
    ...
    $( 'select[data-customize-setting-link="spark_construction_gallery_display"]').trigger( 'on_custom_load' );
...
jQuery( document ).ready( function( $ ) {
    ...
    $.each( FontAwesome_Icon_Picker.fonts, function( key, font ) {
    ...
    icon_picker.find( '.c-icon-search input' ).attr( 'placeholder', FontAwesome_Icon_Picker.search );
