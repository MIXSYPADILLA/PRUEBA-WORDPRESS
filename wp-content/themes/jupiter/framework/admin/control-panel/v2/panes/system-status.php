<?php $sysinfo = mk_control_panel::compileSystemStatus( false, true ); ?>

<div class="mka-cp-pane-box" id="mk-cp-system-status">
    <div class="mka-cp-pane-title">
        ...
        <!-- <div class="mka-wrap mka-tip-wrap">
            ...
            <div class="mka-tip-content"></div>
        </div> -->
    </div>

    <a class="mka-button mka-button--blue mka-button--medium mka-button--get-system-report" href="#">
        <?php esc_html_e( 'Get System Report', 'mk_framework' ); ?>
    </a>

    <div id="mka-textarea--get-system-report">
        <textarea readonly="readonly" onclick="this.focus();this.select()"></textarea>
    </div>

    <table class="mka-cp-system-status-table" cellspacing="0">
        <thead>
        <tr>    
        ...
        <tr>
            ...
            <td class="help">
                <div class="mka-wrap mka-tip-wrap">
                    ...
                    <div class="mka-tip-content"><?php echo esc_attr__( 'The URL of your site\'s homepage.', 'mk_framework' ); ?></div>
                </div>
            </td>
        ...
        <tr>
            ...
            <td class="help">
                <div class="mka-wrap mka-tip-wrap">
                    ...
                    <div class="mka-tip-content"><?php echo esc_attr__( 'The root URL of your site.', 'mk_framework' ); ?></div>
                </div>
            </td>
            <td>
        ...
        <tr>
            ...
            <td class="help">
                <div class="mka-wrap mka-tip-wrap">
                    ...
                    <div class="mka-tip-content"><?php echo esc_attr__( 'The location of Wordpress\'s content URL.', 'mk_framework' ); ?></div>
                </div>
            </td>
            <td>
        ...
        <tr>
            ...
            <td class="help">
                <div class="mka-wrap mka-tip-wrap">
                    ...
                    <div class="mka-tip-content"><?php echo esc_attr__( 'The version of WordPress installed on your site.', 'mk_framework' ); ?></div>
                </div>
            </td>            
            <td>
        ...
        <tr>
            ...
            <td class="help">
                <div class="mka-wrap mka-tip-wrap">
                    ...
                    <div class="mka-tip-content"><?php echo esc_attr__( 'Whether or not you have WordPress Multisite enabled.', 'mk_framework' ); ?></div>
                </div>
            </td>            
        ...
        <tr>
            ...
            <td class="help">
                <div class="mka-wrap mka-tip-wrap">
                    ...
                    <div class="mka-tip-content"><?php echo esc_attr__( 'The current permalink structure as defined in Wordpress Settings->Permalinks.', 'mk_framework' ); ?></div>
                </div>
            </td>            
            <td>
        ...
        <tr>
            ...
            <td class="help">
                <div class="mka-wrap mka-tip-wrap">
                    ...
                    <div class="mka-tip-content"><?php echo esc_attr__( 'The current Reading mode of Wordpress.', 'mk_framework' ); ?></div>
                </div>
            </td>            
                ...
                <tr>
                    ...
                    <td class="help">
                        <div class="mka-wrap mka-tip-wrap">
                            ...
                            <div class="mka-tip-content"><?php echo esc_attr__( 'The currently selected page which acts as the site\'s Front Page.', 'mk_framework' ); ?></div>
                        </div>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td class="help">
                        <div class="mka-wrap mka-tip-wrap">
                            ...
                            <div class="mka-tip-content"><?php echo esc_attr__( 'The currently selected page in where blog posts are displayed.', 'mk_framework' ); ?></div>
                        </div>
                    </td>
                    <td>
        ...
        <tr>
            ...
            <td class="help">
                <div class="mka-wrap mka-tip-wrap">
                    ...
                    <div class="mka-tip-content"><?php echo esc_attr__( 'The maximum amount of memory (RAM) that your site can use at one time.', 'mk_framework' ); ?></div>
                </div>
            </td>
            <td>
<?php
        ...
        <tr>
            ...
            <td class="help">
                <div class="mka-wrap mka-tip-wrap">
                    ...
                    <div class="mka-tip-content"><?php echo esc_attr__( 'The prefix structure of the current Wordpress database.', 'mk_framework' ); ?></div>
                </div>
            </td>
            <td>
        ...
        <tr>
            ...
            <td class="help">
                <div class="mka-wrap mka-tip-wrap">
                    ...
                    <div class="mka-tip-content"><?php echo esc_attr__( 'Displays whether or not WordPress is in Debug Mode.', 'mk_framework' ); ?></div>
                </div>
            </td>
            <td>
        ...
        <tr>
            ...
            <td class="help">
                <div class="mka-wrap mka-tip-wrap">
                    ...
                    <div class="mka-tip-content"><?php echo esc_attr__( 'The current language used by WordPress. Default = English', 'mk_framework' ); ?></div>
                </div>
            </td>            
            <td>
        ...
        <tr>
            ...
            <td class="help">
                <div class="mka-wrap mka-tip-wrap">
                    ...
                    <div class="mka-tip-content"><?php echo esc_attr__( 'The name of the current active theme.', 'mk_framework' ); ?></div>
                </div>
            </td>            
        ...
        <tr>
            ...
            <td class="help">
                <div class="mka-wrap mka-tip-wrap">
                    ...
                    <div class="mka-tip-content"><?php echo esc_attr__( 'The installed version of the current active theme.', 'mk_framework' ); ?></div>
                </div>
            </td>            
            <td>
<?php
        ...
        <tr>
            ...
            <td class="help">
                <div class="mka-wrap mka-tip-wrap">
                    ...
                    <div class="mka-tip-content"><?php echo esc_attr__( 'The theme developers URL.', 'mk_framework' ); ?></div>
                </div>
            </td>            
        ...
        <tr>
            ...
            <td class="help">
                <div class="mka-wrap mka-tip-wrap">
                    ...
                    <div class="mka-tip-content"><?php echo esc_attr__( 'Displays whether or not the current theme is a child theme.', 'mk_framework' ); ?></div>
                </div>
            </td>            
            <td>
<?php
                ...
                <tr>
                    ...
                    <td class="help">
                        <div class="mka-wrap mka-tip-wrap">
                            ...
                            <div class="mka-tip-content"><?php echo esc_attr__( 'The name of the parent theme.', 'mk_framework' ); ?></div>
                        </div>
                    </td>                    
                ...
                <tr>
                    ...
                    <td class="help">
                        <div class="mka-wrap mka-tip-wrap">
                            ...
                            <div class="mka-tip-content"><?php echo esc_attr__( 'The installed version of the parent theme.', 'mk_framework' ); ?></div>
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td class="help">
                        <div class="mka-wrap mka-tip-wrap">
                            ...
                            <div class="mka-tip-content"><?php echo esc_attr__( 'The parent theme developers URL.', 'mk_framework' ); ?></div>
                        </div>
                    </td>                    
        ...
        <tr>
            ...
            <td class="help">
                <div class="mka-wrap mka-tip-wrap">
                    ...
                    <div class="mka-tip-content"><?php echo esc_attr__( 'Information about web browser current in use.', 'mk_framework' ); ?></div>
                </div>
            </td>            
            <td>
<?php
        ...
        <tr>
            ...
            <td class="help">
                <div class="mka-wrap mka-tip-wrap">
                    ...
                    <div class="mka-tip-content"><?php echo esc_attr__( 'Information about the web server that is currently hosting your site.', 'mk_framework' ); ?></div>
                </div>
            </td>            
            <td>
        ...
        <tr>
            ...
            <td class="help">
                <div class="mka-wrap mka-tip-wrap">
                    ...
                    <div class="mka-tip-content"><?php echo esc_attr__( 'Is the server running in a localhost environment.', 'mk_framework' ); ?></div>
                </div>
            </td>            
            <td>
<?php
        ...
        <tr>
            ...
            <td class="help">
                <div class="mka-wrap mka-tip-wrap">
                    ...
                    <div class="mka-tip-content"><?php echo esc_attr__( 'The version of PHP installed on your hosting server.', 'mk_framework' ); ?></div>
                </div>
            </td>            
            <td>
        ...
        <tr>
            ...
            <td class="help">
                <div class="mka-wrap mka-tip-wrap">
                    ...
                    <div class="mka-tip-content"><?php echo esc_attr__( 'The ABSPATH variable on the server.', 'mk_framework' ); ?></div>
                </div>
            </td>            
            <td>
            ...
            <tr>
                ...
                <td class="help">
                    <div class="mka-wrap mka-tip-wrap">
                        ...
                        <div class="mka-tip-content"><?php echo esc_attr__( 'The largest filesize that can be contained in one post.', 'mk_framework' ); ?></div>
                    </div>
                </td>                
            ...
            <tr>
                ...
                <td class="help">
                    <div class="mka-wrap mka-tip-wrap">
                        ...
                        <div class="mka-tip-content"><?php echo esc_attr__( 'max_execution_time : The amount of time (in seconds) that your site will spend on a single operation before timing out (to avoid server lockups).', 'mk_framework' ); ?></div>
                    </div>
                </td>                
            ...
            <tr>
                ...
                <td class="help">
                    <div class="mka-wrap mka-tip-wrap">
                        ...
                        <div class="mka-tip-content"><?php echo esc_attr__( 'The maximum number of variables your server can use for a single function to avoid overloads.', 'mk_framework' ); ?></div>
                    </div>
                </td>                
                ...
                <tr>
                    ...
                    <td class="help">
                        <div class="mka-wrap mka-tip-wrap">
                            ...
                            <div class="mka-tip-content"><?php echo esc_attr__( 'The maximum number of variables your server running Suhosin can use for a single function to avoid overloads.', 'mk_framework' ); ?></div>
                        </div>
                    </td>
            ...
            <tr>
                ...
                <td class="help">
                    <div class="mka-wrap mka-tip-wrap">
                        ...
                        <div class="mka-tip-content"><?php echo esc_attr__( 'Determines if PHP will display errors within the browser.', 'mk_framework' ); ?></div>
                    </div>
                </td>                
                <td><?php
        ...
        <tr>
            ...
            <td class="help">
                <div class="mka-wrap mka-tip-wrap">
                    ...
                    <div class="mka-tip-content"><?php echo esc_attr__( 'The version of MySQL installed on your hosting server.', 'mk_framework' ); ?></div>
                </div>
            </td>            
        ...
        <tr>
            ...
            <td class="help">
                <div class="mka-wrap mka-tip-wrap">
                    ...
                    <div class="mka-tip-content"><?php echo esc_attr__( 'The largest filesize that can be uploaded to your WordPress installation.', 'mk_framework' ); ?></div>
                </div>
            </td>            
        ...
        <tr>
            ...
            <td class="help">
                <div class="mka-wrap mka-tip-wrap">
                    ...
                    <div class="mka-tip-content"><?php echo esc_attr__( 'The default timezone for your server.', 'mk_framework' ); ?></div>
                </div>
            </td>        
            <td>
<?php
...
?>
        ...
        <tr>
            ...
            <td class="help">
                <div class="mka-wrap mka-tip-wrap">
                    ...
                    <div class="mka-tip-content"><?php echo esc_attr__( 'Theme requires PHP XML Library to be installed.', 'mk_framework' ); ?></div>
                </div>
            </td>            
            <td>
                <?php
        ...
        <tr>
            ...
            <td class="help">
                <div class="mka-wrap mka-tip-wrap">
                    ...
                    <div class="mka-tip-content"><?php echo esc_attr__( 'Theme requires MBString PHP Library to be installed.', 'mk_framework' ); ?></div>
                </div>
            </td>            
            <td>
                <?php
        ...
        <tr>
            ...
            <td class="help">
                <div class="mka-wrap mka-tip-wrap">
                    ...
                    <div class="mka-tip-content"><?php echo esc_attr__( 'Theme requires SimpleXML PHP Library to be installed.', 'mk_framework' ); ?></div>
                </div>
            </td>            
            <td>
                <?php
        ...
        <?php
            ...
            $posting['fsockopen_curl']['help'] = esc_attr__( 'Used when communicating with remote services with PHP.', 'mk_framework' );
            ...
            $posting['soap_client']['help'] = esc_attr__( 'Some webservices like shipping use SOAP to get information from remote servers, for example, live shipping quotes from FedEx require SOAP to be installed.', 'mk_framework' );
            ...
            $posting['dom_document']['help'] = esc_attr__( 'HTML/Multipart emails use DOMDocument to generate inline CSS in templates.', 'mk_framework' );
            ...
            $posting['gzip']['help'] = esc_attr__( 'GZip (gzopen) is used to open the GEOIP database from MaxMind.', 'mk_framework' );
            ...
            $posting['wp_remote_post']['help'] = esc_attr__( 'Used to send data to remote servers.', 'mk_framework' );
            ...
            if ( $sysinfo['wp_remote_post'] === 'true' ) {
                ...
                if ( isset($sysinfo['wp_remote_post_error']) ) {
                    $posting['wp_remote_post']['note'] .= ' ' . sprintf( __( 'Error: %s', 'mk_framework' ), sanitize_text_field( $sysinfo['wp_remote_post_error'] ) );
                }
            ...
            $posting['wp_remote_get']['help'] = esc_attr__( 'Used to grab information from remote servers for updates updates.', 'mk_framework' );
            ...
            if ( $sysinfo['wp_remote_get'] === 'true' ) {
                ...
                if ( isset($sysinfo['wp_remote_get_error']) ) {
                    $posting['wp_remote_get']['note'] .= ' ' . sprintf( __( 'Error: %s', 'mk_framework' ), sanitize_text_field( $sysinfo['wp_remote_get_error'] ) );
                }
                ...
                <tr>
                    ...
                    <td class="help">
                        <div class="mka-wrap mka-tip-wrap">
                            ...
                            <div class="mka-tip-content"><?php echo isset( $post['help'] ) ? $post['help'] : ''; ?></div>
                        </div>
                    </td>       
                    <td>
