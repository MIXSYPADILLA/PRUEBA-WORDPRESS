 ...
 * @return void
 */
function sparkconstructionlite_Breadcrumb_Trail( $args = array() ) {

	$breadcrumb = apply_filters( 'breadcrumb_trail_object', null, $args );

	if ( ! is_object( $breadcrumb ) )
		$breadcrumb = new sparkconstructionlite_Breadcrumb_Trail( $args );
 ...
 * @access public
 */
class sparkconstructionlite_Breadcrumb_Trail {
